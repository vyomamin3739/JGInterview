    ...
    <script type="text/javascript">
        ...
        function SetSectionShowHideOnReady ()
        {
            ...
            $("#btnSkillAssPlusNew").click(function () {
                ...
                $(".tblSkillAssessment").show("");          //NandC - Added
            ...
            $("#btnRecruiterPlusNew").click(function () {
                ...
                $(".tblRecruiterAssMinusNew").show();  //NandC - added
            ...
            $("#btnSalesPlusNew").click(function () {
                ...
                $(".tblSalesAssesment").show();             //NandC - added
        ...
        //NandC: for Offer Made status, collapse Assetment section
		function StatusChangeOfferMade()
		{
            var statusSelected = $('#<%= ddlstatus.ClientID %>').val(); 
		    //alert(statusSelected);         

		    if (statusSelected != "OfferMade") {
		        return;
		    }
		    //alert(statusSelected + "2");           

            var optionSelected = $('#<%= ddlPositionAppliedFor.ClientID %>').val();                
		    $('.tblBasicAssessment td').hide("slow");
		    $('#btnBasicPlusNew').hide();
		    $('#btnBasicAssMinusNew').hide();
             ...
             if (optionSelected == "Admin") {
                ...
                $(".tblRecruiterAssMinusNew").hide("slow");
                $(".tblRecruiterAssMinusNew td").hide("slow");
                $('#btnRecruiterPlusNew').show();
                $('#btnRecruiterAssMinusNew').hide();
                $('#btnRecruiterPlusNew').show();
        ...
        {
            //alert('ShowHideRespectiveTableData');
            if (optionSelected == '') {
                            ...
                            <li style="width: 100%;">
                                <table width="100%" id="tblMainNewHire" style="height: 30px;">
                                    <tr>
			                            ...
			                            <label>
				                            Next Review Date<asp:Label ID="Label2" runat="server" Text="*" ForeColor="Red"></asp:Label></label>
		                            ...
		                            <td class="auto-style15"><br />
			                            <label>
				                            Last Review Date<asp:Label ID="Label3" runat="server" Text="*" ForeColor="Red"></asp:Label></label>
                                  ...
                                  <table border="0" class="tblNewHire" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
										    <td class="auto-style15">
										        <div class="grid">
												    <div class="clsOverFlow">
													    <ucAudit:UserListing runat="server" ID="UserListing1" />
											    </div>
												    </div>
										    </td>
                                        </tr>
