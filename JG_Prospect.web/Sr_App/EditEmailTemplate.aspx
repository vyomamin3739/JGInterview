...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="upnlTemplate" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div class="right_panel">
                ...
                <div>
                    ...
                    <div>
                        <h2>Choose Category:
                            <asp:DropDownList ID="drpChooseCategory" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpChooseCategory_SelectedIndexChanged"></asp:DropDownList>
                        </h2>
                        <h2>Subject:
