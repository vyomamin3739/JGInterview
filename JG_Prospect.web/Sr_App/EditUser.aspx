                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="<span class='clsAction'>Action </br> <u>Picture</u></span>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" ItemStyle-Width="7%"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <br />
                                        <asp:Image ID="ImgUserPic" runat="server" ImageUrl='<%#(Eval("picture") == null || Eval("picture") == "") ? "../img/placeholder1.png": Eval("picture")%>' Width="85%" Height="95%" Style="position: relative; top: -25px; padding: 5px;" />
