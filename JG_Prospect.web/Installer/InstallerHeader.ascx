...
<div class="header">
    ...
    <div class="user_panel">
        ...
        <ul>
            <li><a href='<%=Page.ResolveUrl("~/Installer/InstallerHome.aspx")%>'>Home</a></li>
            <li>|</li>
            <li><a href='<%=Page.ResolveUrl("~/Installer/ChangePassword.aspx")%>'>Change Password</a></li>
        </ul>
    </div>
    <div class="nav">
  <ul>
  <li id="Li_Dashboard" runat="server" ><a href='<%=Page.ResolveUrl("~/Installer/InstallerHome.aspx")%>'>Dashboard</a></li>
